...
RUN wget --no-check-certificate "https://stockfishchess.org/files/stockfish_14_linux_x64_avx2.zip" -O stockfishmodern.zip
...
RUN mv stockfish_14_linux_x64_avx2 stockfishmodern
