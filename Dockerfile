...
RUN wget --no-check-certificate "https://abrok.eu/stockfish/builds/dabaf2220fe0c77400a5f71a91952f510e6a126b/linux64avx2/stockfish_21080516_x64_avx2.zip" -O stockfishmodern.zip
...
RUN mv stockfish_21080516_x64_avx2 stockfishmodern
