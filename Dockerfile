...
RUN wget --no-check-certificate "https://abrok.eu/stockfish/builds/dabaf2220fe0c77400a5f71a91952f510e6a126b/linux64ssse/stockfish_21080516_x64_ssse.zip" -O stockfishmodern.zip
...
RUN mv stockfish_21080516_x64_ssse stockfishmodern
